...
function twentytwenty_register_styles() {
	...
	// Add carousel CSS.
	wp_enqueue_style( 'twentytwenty-carousel-style', get_template_directory_uri() . '/carousel.css', null, $theme_version );
	wp_enqueue_script( 'twentytwenty-carousel-script', get_template_directory_uri() . '/carousel.js', null, false , true );
